...
/* Command-line: gperf.exe -t --output-file=src/generated/gperf_hash_tables/Extension-Member-Lookup.cc -CGD ./src/generated/gperf_class_files/Extension.gperf  */
...
#line 8 "./src/generated/gperf_class_files/Extension.gperf"
...
class Extension_Gperf
{
private:
  static inline unsigned int hash (const char *str, unsigned int len);
public:
  static const struct fhir_deserialize::MemberNameAndOffset *Extension_MemberLookup (const char *str, unsigned int len);
};

inline unsigned int
Extension_Gperf::hash (register const char *str, register unsigned int len)
{
...
#line 55 "./src/generated/gperf_class_files/Extension.gperf"
...
#line 19 "./src/generated/gperf_class_files/Extension.gperf"
    {"valueDate", 0x40, 6, 4, {(U8*)"value", 5}, fhir_deserialize::ResourceType::Unknown, 16, fhir_deserialize::ResourceType::Unknown},
#line 38 "./src/generated/gperf_class_files/Extension.gperf"
...
Extension_Gperf::Extension_MemberLookup (register const char *str, register unsigned int len)
{
      ...
      if (key <= MAX_HASH_VALUE && key >= 0)
        {
          ...
          if (index >= 0)
            {
              register const char *s = word_array_Extension[index].name;

              if (*str == *s && !strncmp (str + 1, s + 1, len - 1) && s[len] == '\0')
                return &word_array_Extension[index];
            }
        }
    }
  return 0;
