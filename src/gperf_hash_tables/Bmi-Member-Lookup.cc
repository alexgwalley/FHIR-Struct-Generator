...
/* Command-line: gperf.exe -t --output-file=src/gperf_hash_tables/Bmi-Member-Lookup.cc -CGD ./gperf_class_files/Bmi.gperf  */
/* Computed positions: -k'' */

#line 8 "./gperf_class_files/Bmi.gperf"
...
static const struct fhir_deserialize::MemberNameAndOffset word_array_Bmi[] =
  {
#line 10 "./gperf_class_files/Bmi.gperf"
