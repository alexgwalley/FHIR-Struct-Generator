...
/* Command-line: gperf.exe -t --output-file=src/gperf_hash_tables/Cqf_questionnaire-Member-Lookup.cc -CGD ./gperf_class_files/Cqf_questionnaire.gperf  */
/* Computed positions: -k'' */

#line 8 "./gperf_class_files/Cqf_questionnaire.gperf"
...
static const struct fhir_deserialize::MemberNameAndOffset word_array_Cqf_questionnaire[] =
  {
#line 10 "./gperf_class_files/Cqf_questionnaire.gperf"
