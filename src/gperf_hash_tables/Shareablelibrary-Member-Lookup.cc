...
/* Command-line: gperf.exe -t --output-file=src/gperf_hash_tables/Shareablelibrary-Member-Lookup.cc -CGD ./gperf_class_files/Shareablelibrary.gperf  */
/* Computed positions: -k'' */

#line 8 "./gperf_class_files/Shareablelibrary.gperf"
...
static const struct fhir_deserialize::MemberNameAndOffset word_array_Shareablelibrary[] =
  {
#line 10 "./gperf_class_files/Shareablelibrary.gperf"
