...
/* Command-line: gperf.exe -t --output-file=src/gperf_hash_tables/Shareableactivitydefinition-Member-Lookup.cc -CGD ./gperf_class_files/Shareableactivitydefinition.gperf  */
/* Computed positions: -k'' */

#line 8 "./gperf_class_files/Shareableactivitydefinition.gperf"
...
static const struct fhir_deserialize::MemberNameAndOffset word_array_Shareableactivitydefinition[] =
  {
#line 10 "./gperf_class_files/Shareableactivitydefinition.gperf"
