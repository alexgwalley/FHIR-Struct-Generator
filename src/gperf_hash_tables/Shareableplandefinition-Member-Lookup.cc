...
/* Command-line: gperf.exe -t --output-file=src/gperf_hash_tables/Shareableplandefinition-Member-Lookup.cc -CGD ./gperf_class_files/Shareableplandefinition.gperf  */
/* Computed positions: -k'' */

#line 8 "./gperf_class_files/Shareableplandefinition.gperf"
...
static const struct fhir_deserialize::MemberNameAndOffset word_array_Shareableplandefinition[] =
  {
#line 10 "./gperf_class_files/Shareableplandefinition.gperf"
